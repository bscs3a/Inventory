        ...
        <div class="flex flex-row flex-wrap justify-center mx-24 mt-8">
            ...
            <div class="flex-1 p-4 w-full max-w-5xl">
                ...
                <div class="flex items-start">
                    ...
                    <div class="mb-6 ml-3 flex-1">
                        ...
                        <label for="large-input" class="block mb-2 text-lg font-medium text-gray-900 my-2">Product
                            Name</label>
                        <input type="text" id="product" name="product" value="<?php echo $product['product']; ?>" disabled class="block w-full p-3 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
                ...
                <div class="mb-6 ml-3">
                    <label for="large-input" class="block mb-2 text-lg font-medium text-gray-900 my-2">Product
                        Price</label>
                    <input type="text" id="price" name="price" value="<?php echo $product['price']; ?>" disabled class="block w-full p-3 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
        </div>
        <!-- End: Edit content -->
            ...
            <div class="flex-1 p-4 mx-5 mt-5 mb-5 rounded-lg bg-white border border-gray-600 flex-col shadow-md">
                ...
                <div class="flex justify-between mx-36 my-3 text-xl">
                    ...
                    <div class="flex justify-evenly">
                        ...
                        <div class="px-2">
                            <button data-modal-target="order-modal" data-modal-toggle="order-modal" class="items-end rounded-full text-lg bg-sidebar text-white px-6 py-1 hover:bg-slate-600 active:bg-slate-700 duration-75">
        ...
        <div id="order-modal" class="modal fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50 hidden">
            ...
            <div class="bg-white rounded shadow-lg w-3/4 sm:w-2/3 md:w-1/2 lg:w-1/3 h-3/4 sm:h-2/3 md:h-1/2 lg:h-1/2 overflow-auto">
                <div class="pl-3 pr-3 pt-3 flex">
                    ...
                    <button data-modal-hide="order-modal" class="ml-auto text-gray-600 hover:text-gray-800 cursor-pointer">
                ...
                <div class="flex justify-center items-center mt-4 mb-4 space-x-4">
                    <div>
                        <button data-modal-hide="order-modal" class="rounded-full text-lg border border-black text-black px-6 py-1 hover:bg-gray-100 active:bg-gray-300 duration-75">
                            Back
                        </button>
                    </div>
                    <div>

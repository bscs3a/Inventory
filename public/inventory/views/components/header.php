    ...
    <ul class="ml-auto flex items-center">
        ...
        <li class="dropdown ml-3 relative">
            ...
            <ul class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-md hidden">
                <li class="px-4 py-2 hover:bg-gray-200 text-center cursor-pointer rounded-lg"><a
                        route='/inv/accountsett'>
                        Account Settings</a>
                </li>
        ...
        <script>
            $(document).ready(function () {
                $(' .dropdown').click(function () { $(this).find('ul').toggleClass('hidden'); });
            }); </script>
        <!-- End: Profile -->
</div>

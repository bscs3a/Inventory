...
<body>
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 min-h-screen transition-all main">
        ...
        <div class="grid grid-cols-2 gap-4 m-2">
            ...
            <div class="flex px-4 w-full rounded-lg bg-white border border-gray-600 flex-col shadow-md">
                ...
                <div class="flex place-content-end mt-2 m-3">
                    <button data-modal-target="totalstock-modal" data-modal-toggle="totalstock-modal"
        ...
        <!-- Main modal -->
        <div id="totalstock-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button data-modal-hide="totalstock-modal" type="button"
